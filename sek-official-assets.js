(() => {
  ...
  const overrides={
    ...
    "SEK:1000":{front:"/assets/notes/sek/sek-1000-front.png",back:"/assets/notes/sek/sek-1000-back.png",dimensions:"154 × 66 mm"}
  };
  ...
  window.fetch=async(...args)=>{
    ...
    notes.forEach(n=>{
      ...
      if(x)Object.assign(n,x,{status:'circulating',statusLabel:'Em circulação',source:'Sveriges Riksbank',material:'Papel de algodão',imageStatus:n.currency==='SEK'&&Number(n.value)===1000?'local-reproduction':'official-reproduction',imageSource:n.currency==='SEK'&&Number(n.value)===1000?'Imagem fornecida pelo utilizador · Sveriges Riksbank':'Sveriges Riksbank',imageSourceUrl:PAGE});
    });
