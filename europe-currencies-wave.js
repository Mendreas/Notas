(() => {
  ...
  const currencyMeta={
    ...
    MKD:{name:'Denar macedónio',symbol:'ден',group:'Macedónia do Norte',source:'National Bank of the Republic of North Macedonia',rate:61.5,material:'Papel / polímero',notes:[10,50,100,200,500,1000,2000],countries:['MKD'],officialUrl:'https://www.nbrm.mk/banknotes.nspx'},
