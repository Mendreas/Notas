(() => {
 ...
 const countries=[
 {id:'IRN',name:'Irão',flag:'🇮🇷',continent:'Asia',currency:'IRR',capital:'Teerão',language:'Persa'},
 ...
 const cfg={
 IRR:{name:'Rial iraniano',symbol:'﷼',notes:[10000,20000,50000,100000,500000,1000000,2000000,5000000,10000000],countries:['IRN'],source:'Central Bank of the Islamic Republic of Iran'},
 SYP:{name:'Libra síria',symbol:'£S',notes:[50,100,200,500,1000,2000,5000],countries:['SYR'],source:'Central Bank of Syria'},
 YER:{name:'Rial iemenita',symbol:'﷼',notes:[50,100,200,250,500,1000],countries:['YEM'],source:'Central Bank of Yemen'}};
