const CACHE="notas-mundo-v051";
const CORE=["/","/index.html","/app.css","/viewer.css","/app.js","/manifest.webmanifest","/data/countries.json","/data/currencies.json","/data/notes.json","/data/iso-map.json","/assets/icon.svg"];
