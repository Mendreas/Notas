(() => {
 ...
 const countries=[
 {id:'ISR',name:'Israel',flag:'🇮🇱',continent:'Asia',currency:'ILS',capital:'Jerusalém',language:'Hebraico / Árabe'},
 {id:'IRQ',name:'Iraque',flag:'🇮🇶',continent:'Asia',currency:'IQD',capital:'Bagdade',language:'Árabe / Curdo'},
 {id:'LBN',name:'Líbano',flag:'🇱🇧',continent:'Asia',currency:'LBP',capital:'Beirute',language:'Árabe'}];
 const cfg={
 ILS:{name:'Novo shekel israelita',symbol:'₪',notes:[20,50,100,200],countries:['ISR'],source:'Bank of Israel'},
 IQD:{name:'Dinar iraquiano',symbol:'ع.د',notes:[250,500,1000,5000,10000,25000,50000],countries:['IRQ'],source:'Central Bank of Iraq'},
 LBP:{name:'Libra libanesa',symbol:'ل.ل',notes:[1000,5000,10000,20000,50000,100000],countries:['LBN'],source:'Banque du Liban'}};
